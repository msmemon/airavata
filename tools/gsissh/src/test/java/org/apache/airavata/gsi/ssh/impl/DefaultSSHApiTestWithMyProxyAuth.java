...
//        System.setProperty("gsi.working.directory", "/home/ogce");
    ...
    public void testExecuteCommand() throws Exception {
        ...
        // Server info
        ServerInfo serverInfo = new ServerInfo(myProxyUserName, "trestles.sdsc.edu");
        ...
        System.out.println("Shahbaz Memon " + new BufferedOutputStream(commandOutput.getStandardError()));
    }
...
//        Cluster cluster = sshApi.getCluster(serverInfo, authenticationInfo);
    ...
    public void testSLURMAsync() throws Exception {
        ...
        // Server info
        ServerInfo serverInfo = new ServerInfo(myProxyUserName, "stampede.tacc.xsede.org");
