...
public class UNICORESecurityContext extends GSISecurityContext {
	 ...
	 */
	public DefaultClientConfiguration getDefaultConfiguration() throws GFacException {
...
//			setExtraSettings();
	 ...
	 * @throws GFacProviderException
	 */
	public DefaultClientConfiguration getServerSignedConfiguration(String userID, String userDN, String caCertPath, String caKeyPath, String caKeyPwd) throws GFacProviderException {
		try {
