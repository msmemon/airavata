...
public class GSISSHProviderTestWithMyProxyAuth {
    ...
    public void setUp() throws Exception {
        ...
        System.setProperty("gsi.certificate.path", "/home/m.memon/.globus/certificates");
...
//		((StringParameterType)echo_input.getType()).setValue("echo_output=hello");
        ...
        jobExecutionContext.setRegistry(RegistryFactory.getDefaultRegistry());
    ...
    private SecurityContext getSecurityContext(HpcApplicationDeploymentType app) {
        ...
        // Server info
        ServerInfo serverInfo = new ServerInfo("msmemon", "trestles.sdsc.edu");
